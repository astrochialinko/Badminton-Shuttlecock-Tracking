...
def TrackNet( input_height, input_width ): #input_height = 288, input_width = 512
	...
	#Layer18
	x = concatenate( [UpSampling2D( (2,2), data_format='channels_last')(x), x2], axis=1)
	...
	#Layer21
	x = concatenate( [UpSampling2D( (2,2), data_format='channels_last')(x), x1], axis=1)
	...
	#Layer24
	x =  Conv2D( 1 , (1, 1) , kernel_initializer='random_uniform', padding='same', data_format='channels_last' )(x)
